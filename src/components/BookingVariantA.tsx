    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-h-0 md:min-h-[520px]">
          {/* Booking form panel */}
          <div className={`flex-1 min-h-0 relative flex flex-col ${step === 0 ? 'overflow-y-auto overflow-x-hidden bg-white/60 backdrop-blur-xl px-6 pt-5 pb-8 md:px-10 md:py-10 lg:px-12' : 'overflow-hidden bg-white p-0'}`}>
