...
function BlogComponent() {
  return (
    ...
    >
      {/* ========== <a href="https://www.endocrine.org/news-and-advocacy/news-room/" target="_blank" rel="noopener noreferrer" className="text-secondary font-medium hover:underline">Section</a> 1: The 3 PM Wall ========== */}
      ...
      {/* ========== Section 2: You're Not <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1592560/" target="_blank" rel="noopener noreferrer" className="text-secondary font-medium hover:underline">Imagining</a> It ========== */}
      <section id="youre-not-imagining-it">
        ...
        <p className="text-lg leading-relaxed text-foreground/85 mb-5">
          Research shows that perimenopause, the transitional period before menopause, can begin as
          early as age 35 and last for 10 to 15 years. That means a 38-year-old woman in Troy and a
          52-year-old woman in Marquette could both be dealing with the exact same hormonal
        ...
        <p className="text-lg leading-relaxed text-foreground/85 mb-5">
          ...
          majority of them will experience symptoms, including weight gain, fatigue, brain fog, mood
          swings, sleep disruption, and joint pain, that significantly impact their quality of life.
        </p>
