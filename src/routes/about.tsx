...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet Kathryn Long, NP-C  board-certified nurse practitioner with 20+ years in healthcare, specializing in hormones, metabolic health, and weight resistance for women in midlife." },
      { property: "og:title", content: "About Kathryn Long, NP-C | Novaleo Weight & Wellness" },
      { property: "og:description", content: "Functional medicine for professional women in MI & WI  led by Kathryn Long, NP-C." },
    ],
  }),
  component: About,
});
    ...
    <>
      <section className="container-prose pt-8 pb-12">
        ...
        <h1 className="text-5xl md:text-7xl max-w-3xl leading-[1.02]">
          Meet <em className="text-secondary not-italic">Kathryn Long</em><span className="text-2xl md:text-3xl align-baseline">, NP-C.</span>
        </h1>
      ...
      <section className="container-prose pb-24 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          <img src={clinician} alt="Kathryn Long, NP-C  founder of Novaleo Weight & Wellness" width={1000} height={1200} loading="lazy"
          ...
          <div className="mt-5">
            ...
            <div className="text-sm text-muted-foreground">Founder · Board-Certified Nurse Practitioner</div>
          </div>
        </div>
        <div className="lg:col-span-7">
          <SectionHeading
            eyebrow="My story"
            title="I know what it's like to feel unheard."
          />
          <div className="mt-8 space-y-5 text-foreground/85 leading-relaxed text-lg">
            <p>
              For years, I battled relentless fatigue and brain fog, only to be told by doctors
              that everything was "fine." That dismissal became my turning point.
            </p>
            <p>
          ...
          <div className="mt-10 grid sm:grid-cols-2 gap-6">
            {[
              { k: "Credentials", v: "Board-Certified Nurse Practitioner (NP-C), Certified in Medical Weight Management." },
              { k: "Experience", v: "20+ years in clinical healthcare, with deep specialization in hormones and metabolic health." },
              { k: "Who I serve", v: "Professional women in their 40s and 50s navigating fatigue, hormones, and weight resistance." },
              { k: "How I practice", v: "100% telehealth across Michigan and Wisconsin  care that meets your real schedule." },
            ].map((b) => (
        ...
        <div className="container-prose py-20 grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            ...
            <h2 className="text-4xl md:text-5xl leading-tight">
              A second act defined by <em className="text-secondary not-italic">vitality</em>, not exhaustion.
            </h2>
          </div>
      ...
      <section className="container-prose py-20">
        ...
        <h2 className="text-4xl md:text-5xl text-center max-w-2xl mx-auto">Care built on values, not volume.</h2>
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="container-prose py-20 text-center">
          <h2 className="text-4xl md:text-5xl text-primary-foreground">Let's start with a conversation.</h2>
          <p className="mt-4 text-primary-foreground/75 max-w-xl mx-auto">
            A relaxed, judgment-free 15-minute Google Meet call with Kathryn. Zero cost, zero pressure.
          </p>
          <Link to="/contact" className="btn-gold mt-7 inline-flex">Reserve my free call</Link>
        </div>
      </section>
    </>
  );
