...
- **Lead Magnet / Free Guide (`/free-guide`)**: A dedicated landing page for the "What Your Labs Aren't Telling You" PDF guide. Features an opt-in area for lead generation and summarizes key takeaways from the guide.
