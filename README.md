...
- **Global Booking Modal**: A seamless unified pop-up experience for discovery calls across all pages.
  ...
  - Consistent global popup integration, including the "Free 15 min call with Katie" buttons on the contact page.
  - **Custom Mobile Discovery Layout**: The dedicated `/free-15-min-call-with-katie` landing page features a specialized mobile layout that replaces the standard location gate with a high-converting, trust-building clinician bio. This layout includes an Instagram-style verified badge, a rotating carousel of verified 5-star patient reviews, and a highly polished CTA button with a shimmer animation, optimized specifically for Meta Ads traffic.
- **UI Enhancements**: Consistent pointer interactions, standardized branding colours, and a personalized clinician avatar with active availability indicators.
  ...
  - Mobile-first refinements ensure the primary "Free 15 min call with Katie" button stays visible above the fold on the homepage hero section.
